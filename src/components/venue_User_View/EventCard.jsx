...
import { MapPin, Loader2 } from "lucide-react"; // Import spinner
...
const EventCard = ({ visibleCards }) => {
  ...
  const [deletingId, setDeletingId] = useState(null); // track deleting card
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              {deletingId === item.id ? (
                                <Loader2 className="size-7 animate-spin text-red-700" />
                              ) : (
