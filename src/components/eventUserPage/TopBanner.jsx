...
const TopBanner = () => {
  return (
    ...
    <button className="bg-[#0E1060] py-2 px-4 w-full text-2xl font-semibold text-white">Más Detalles del Evento</button>
    <button className="bg-[#000] py-5 rounded-xl my-10 px-4 w-full text-2xl font-semibold text-white">ENTRADAS</button>
    <div className="flex justify-between items-center">
      <Title24>$10.000 - 50.000</Title24>
      <Title24>Límite de Edad: 21+</Title24>
    </div>
    <div className="pt-10 pb-20 max-w-[620px] space-y-10 text-center mx-auto">
