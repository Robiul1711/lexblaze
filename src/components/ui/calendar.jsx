  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "hover:bg-black text-white bg-black hover:text-white ",
        day_today: "hover:bg-black text-white bg-black hover:text-white ",
        day_outside:
          "day-outside text-zinc-500 aria-selected:bg-zinc-100/50 aria-selected:text-zinc-500 ",
