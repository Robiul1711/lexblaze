...
const BusinessProfilePage = () => {
  ...
  return (
    <div className="container mx-auto">
        ...
        <div className='size-9 rounded-2xl !bg-[#fff] z-50   absolute top-1 right-1'></div>
            ...
            <div className="overflow-y-auto max-h-[60vh] pr-4">
              ...
              <div className="pt-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-bold text-lg mb-2 text-[#000e8e]">
                    1. Applicability & Jurisdiction / Aplicabilidad y Jurisdicción
                  </h3>
                  <p className="mb-2">
                    <span className="font-semibold text-gray-700">English:</span>
                    <br />
                    This Service is provided by Hoy Familia...
                  </p>
                  <p>
                    <span className="font-semibold text-gray-700">Español:</span>
                    <br />
                    Este Servicio es proporcionado por Hoy Familai...
                  </p>
                </div>

                {/* Other sections... */}

                <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-[#000e8e]">
                  <h3 className="font-bold text-lg mb-2 text-[#000e8e]">
                    Acceptance / Aceptación
                  </h3>
          ...
          <div className="flex justify-between gap-4 mt-6 px-4">
            <Button 
              ...
              variant="outline"
              className=" text-[#000e8e] hover:bg-gray-100 hover:text-[#000e8e] px-8 py-3 text-lg font-bold"
            >
              Rechazar
            </Button>
            <Button 
              onClick={handleAcceptTerms}
              className="bg-[#000e8e] hover:bg-[#0000cc] text-white px-8 py-3 text-lg font-bold"
            >
              Aceptar
            </Button>
          </div>
      ...
      {termsAccepted && <BusinessProfileForm />}
    </div>
  );
};
