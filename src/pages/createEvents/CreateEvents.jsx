...
const CreateEvents = () => {
  ...
  return (
    <div className="max-w-[590px] mx-auto mt-16 mb-[220px] px-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
        ...
        <div className="flex flex-col items-center gap-2 mt-6">
          ...
          <input
            ...
            className="hidden"
          />
          <button className="bg-[#000e8e] text-white px-12 py-2 rounded-md text-2xl font-bold mt-4">
        ...
        {/* Fecha */}
        <div>
          <h1 className="text-[32px] font-bold">Elija Fecha</h1>
          <button className="text-lg bg-[#000e8e] px-3 py-2 rounded-xl mt-4 text-white font-bold">
            Más Información
          </button>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 right-4 transform -translate-y-1/2 flex gap-2 items-center">
            <p className="px-3 py-2 bg-[#DDDDE3] text-[#029AFF] rounded-xl">04:21 PM</p>
            <button
              type="button"
              onClick={toggleStart}
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 right-4 transform -translate-y-1/2 flex gap-2 items-center">
            ...
            >
              <div
                className={`absolute top-1 h-8 w-9 rounded-lg bg-white shadow-md transform transition-transform duration-300 ${
                  isAmEnd ? "translate-x-0 left-1.5" : "translate-x-10 left-2"
                }`}
              />
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-black">
                AM
        ...
        {/* Detalles */}
        <h1 className="text-[32px] font-bold">Detalles del Evento</h1>
        ...
        <div>
          <button className="bg-[#000e8e] text-white px-6 py-2 rounded-md text-2xl font-bold">
        ...
        <div>
          <h1 className="text-[32px] font-bold">Carga Otra Imagen </h1>
          <p className="text-xl font-bold">(opcional) Volante, Anuncio, Cartel, etc.</p>
        </div>
        <div className="flex flex-col items-center gap-2 mt-6">
          <label
            htmlFor="extra-image"
          ...
          <input
            ...
            className="hidden"
          />
          <button className="bg-[#000e8e] text-white px-20 py-2 rounded-md text-2xl font-bold mt-4">
            Carga Imagenes
          </button>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 mt-6">
          <button
            type="submit"
            className="bg-[#11D619] hover:bg-green-600 text-white font-semibold py-3 px-24 text-3xl rounded-[20px] mt-4"
          >
            Publicar
          </button>
        </div>
